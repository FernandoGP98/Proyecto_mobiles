...
class ImagePicker2(private val activity: Activity) {
    ...
    fun onActivityResult(requestCode2: Int, resultCode2: Int, data2: Intent?): Bitmap? {
        if (requestCode2 == MY_REQUEST_PICK_IMAGE) {
    ...
    companion object {
        const val MY_REQUEST_PICK_IMAGE = 1001
