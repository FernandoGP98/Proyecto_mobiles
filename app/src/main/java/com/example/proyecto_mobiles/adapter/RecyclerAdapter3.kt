...
import com.example.proyecto_mobiles.fragment_info_pendiente
...
class RecyclerAdapter3(private val itemsList: List<ItemList>) : RecyclerView.Adapter<RecyclerAdapter3.RecycleHolder>(),
    Filterable {
    ...
    override fun onBindViewHolder(holder: RecycleHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener(object: View.OnClickListener{
            override fun onClick(v: View?){
                ...
                val fragmentInfo=fragment_info_pendiente()
